...
export const Hero3DWebGL = () => {
  const titleWords = "GeoContent Publisher".split(" ")
  const subtitle = "Автоматическая генерация и публикация GEO-статей на Habr, Dzen и VC.ru — чтобы вас цитировали ИИ-ассистенты."
