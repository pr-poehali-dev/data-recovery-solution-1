      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="font-space-mono text-gray-300 mb-6 max-w-md">
              Автоматическая генерация GEO-оптимизированного контента для Habr, Дзен и VC.ru — чтобы вас цитировали ChatGPT, Perplexity и другие ИИ-ассистенты.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-red-500/20">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="font-space-mono text-gray-400 text-sm">2025 GeoContent Publisher. Все права защищены.</p>
